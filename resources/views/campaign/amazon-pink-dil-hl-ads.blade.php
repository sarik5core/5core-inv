@extends('layouts.vertical', ['title' => 'Amazon - PINK DIL HL ADS', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Amazon - PINK DIL HL ADS',
        'sub_title' => 'Amazon - PINK DIL HL ADS',
    ])
    <div class="row">
        <div class="col-12">
