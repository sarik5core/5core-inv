...
<style type="text/css">
    ...
    background-color: transparent !important; /* Reset default */
}
...
table#campaigns-table td.text-end.red-bg {
   ...
   .green-bg {
    ...
    .editable .cell-value {
        display: inline-block;
        width: 100%;
        padding-right: 60px; /* Space for Done button in sbid column */
    }
    .editable .cell-value:focus {
        outline: none;
    }
    .saving {
        background-color: #fff3cd; /* Light yellow for saving state */
    }
    .text-end {
    text-align: right;
     font-weight: bold;
    ...
    <div class="col-md-4">
        <input type="date" id="endDate" class="form-control" placeholder="End Date">
                    ...
                    <div  style="max-height: 70vh;">
                        <table id="campaigns-table" class="table table-hover nowrap align-middle table-bordered border-primary w-100">
