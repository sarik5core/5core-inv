@extends('layouts.vertical', ['title' => 'Walmart - Correctly Utilised', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    @include('layouts.shared.page-title', [
        'page_title' => 'Walmart - Correctly Utilised',
        'sub_title' => 'Walmart - Correctly Utilised',
    ])
    <div class="row">
        <div class="col-12">
