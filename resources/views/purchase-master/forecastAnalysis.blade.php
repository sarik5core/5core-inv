...
@section('content')
@include('layouts.shared.page-title', ['page_title' => 'Forecast Analysis', 'sub_title' => 'Forecast Analysis'])
            ...
            <div class="card-body">
                <div class="mb-3 d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <!-- Yellow Count -->
                        <div id="yellow-count-container" class="d-none px-3 btn rounded-2 shadow-sm border border-danger bg-danger">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content border-0 shadow-sm">
            ...
            <div class="modal-body" id="monthModalBody">
                <div class="d-flex justify-content-between gap-2 flex-nowrap w-100 px-3" id="monthCardWrapper" style="overflow-x: auto;">
...
<div class="modal fade" id="editNotesModal" tabindex="-1" role="dialog" aria-labelledby="editNotesLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg shadow-none" role="document">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body">
                <textarea id="notesInput" class="form-control form-control-lg shadow-none mb-4" rows="3" placeholder="Type your note here..." style="resize: vertical;" ></textarea>
                <div class="text-end">
...
<script>
        ...
        columns: [
            {
                ...
                cellMouseOver: function(e, cell) {
                    ...
                    preview.innerHTML = `<img src="${fullUrl}" style="max-width:350px;max-height:350px;">`;
            ...
            { title: "Supplier Tag", field: "Supplier Tag", accessor: row => row["Supplier Tag"] },
            {
                title: "NR",
                field: "nr",
            ...
            const matchingChildren = children.filter(child =>
                ...
                (currentColorFilter === 'red'
                    ...
                    : currentColorFilter === 'yellow'
                        ? child.to_order >= 0 && (!child["Approved QTY"] || child["Approved QTY"].toString().trim() === '')
                        : true) &&
        ...
        table.setFilter(function (row) {
            ...
            if (currentParentFilter) {
                if (isParent) {
                    ...
                    return data.Parent === currentParentFilter && matchesColor && matchesNR && matchesApprovedQty;
                }
            }
    ...
    document.addEventListener('DOMContentLoaded', function () {
      document.documentElement.setAttribute("data-sidenav-size", "condensed");
        ...
        document.getElementById('order-color-filter-dropdown').innerHTML = '<i class="bi bi-funnel-fill"></i> Yellow Filter';
        setCombinedFilters();

        document.querySelectorAll('#order-color-filter-dropdown + .dropdown-menu [data-filter]').forEach(btn => {
            btn.addEventListener('click', function () {
                const filter = this.getAttribute('data-filter');
                currentColorFilter = filter || null;
                setCombinedFilters();

                const buttonText = filter ? filter.charAt(0).toUpperCase() + filter.slice(1) + ' Filter' : 'All';
                document.getElementById('order-color-filter-dropdown').innerHTML = `<i class="bi bi-funnel-fill"></i> ${buttonText}`;
        ...
        document.getElementById('toggle-nr-rows').addEventListener('click', function () {
            ...
            if (currentColorFilter === 'yellow') {
                ...
                const yellowCount = allData.filter(r => r.to_order >= 0 && !r.is_parent && (hideNRYes ? r.nr !== 'NR' : true)).length;
                document.getElementById('yellow-count-box').textContent = `Approval Pending: ${yellowCount}`;
            }
