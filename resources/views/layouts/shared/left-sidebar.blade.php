...
<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            @php
                $hasUser =
                    (isset($permissions['roles']) && in_array('view', $permissions['roles'])) ||
                    (isset($permissions['permissions']) && in_array('view', $permissions['permissions']));
                $isAdmin = auth()->check() && in_array(auth()->user()->role, ['admin', 'super admin']);
            @endphp
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages1">
                        <ul class="side-nav-second-level">
                            @if ($isAdmin && isset($permissions['roles']) && in_array('view', $permissions['roles']))
                                <li>
                                    <a href="{{ route('roles') }}">Roles</a>
                                </li>
                            @endif
                            @if (isset($permissions['permissions']) && in_array('view', $permissions['permissions']))
                                <li>
            ...
            @php
                $hasPurchaseMasters =
                    (isset($permissions['purchase_master_categories']) &&
                        in_array('view', $permissions['purchase_master_categories'])) ||
                    (isset($permissions['purchase_master_suppliers']) &&
                        in_array('view', $permissions['purchase_master_suppliers']));
            @endphp
            ...
            @php
                $hasProductMasters =
                    (isset($permissions['product_lists']) && in_array('view', $permissions['product_lists'])) ||
                    (isset($permissions['pricing_masters']) && in_array('view', $permissions['pricing_masters'])) ||
                    (isset($permissions['listing_analysis']) && in_array('view', $permissions['listing_analysis'])) ||
                    (isset($permissions['cost_price_analysis']) &&
                        in_array('view', $permissions['cost_price_analysis'])) ||
                    (isset($permissions['movement_analysis']) && in_array('view', $permissions['movement_analysis'])) ||
                    (isset($permissions['in_order_analysis']) && in_array('view', $permissions['in_order_analysis'])) ||
                    (isset($permissions['transit_analysis']) && in_array('view', $permissions['transit_analysis'])) ||
                    (isset($permissions['review_analysis']) && in_array('view', $permissions['review_analysis'])) ||
                    (isset($permissions['profit_roi_analysis']) &&
                        in_array('view', $permissions['profit_roi_analysis'])) ||
                    (isset($permissions['returns_analysis']) && in_array('view', $permissions['returns_analysis'])) ||
                    (isset($permissions['stock_analysis']) && in_array('view', $permissions['stock_analysis'])) ||
                    (isset($permissions['shortfall_analysis']) && in_array('view', $permissions['shortfall_analysis']));
            @endphp
            ...
            @if ($hasProductMasters)
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPagess">
                        <ul class="side-nav-second-level">
                            @if (isset($permissions['product_lists']) && in_array('view', $permissions['product_lists']))
                                <li>
                                    <a href="{{ route('product.master') }}">CP
                                        Masters</a>
                                </li>
                            @endif
                            @if (isset($permissions['pricing_masters']) && in_array('view', $permissions['pricing_masters']))
                                <li>
                            ...
                            @endif
                            @if (isset($permissions['cost_price_analysis']) && in_array('view', $permissions['cost_price_analysis']))
                                <li>
                                    <a href="{{ route('costprice.analysis') }}">Cost Price Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['movement_analysis']) && in_array('view', $permissions['movement_analysis']))
                                <li>
                                    <a href="{{ route('movement.analysis') }}">Movement Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['tobedc_list']) && in_array('view', $permissions['tobedc_list']))
                                <li>
                                    <a href="{{ route('tobedc.list') }}">2BDC</a>
                                </li>
                            @endif
                            {{-- @if (isset($permissions['in_order_analysis']) && in_array('view', $permissions['in_order_analysis']))
                            <li>
                                <a href="{{ route('second', ['pages', 'in-order-analysis']) }}">In Order
                                    Analysis</a>
                            </li>
                            @endif --}}
                            @if (isset($permissions['transit_analysis']) && in_array('view', $permissions['transit_analysis']))
                                <li>
                                    <a href="{{ route('second', ['pages', 'transit-analysis']) }}">Transit Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['review_analysis']) && in_array('view', $permissions['review_analysis']))
                                <li>
                                    <a href="{{ route('review.analysis') }}">Review Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['profit_roi_analysis']) && in_array('view', $permissions['profit_roi_analysis']))
                                <li>
                                    <a href="{{ route('pRoi.analysis') }}">Profit & ROI Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['returns_analysis']) && in_array('view', $permissions['returns_analysis']))
                                <li>
                                    <a href="{{ route('return.analysis') }}">Returns Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['stock_analysis']) && in_array('view', $permissions['stock_analysis']))
                                <li>
                                    <a href="{{ route('stock.analysis') }}">Stock Verification</a>
                                </li>
                            @endif
                            @if (isset($permissions['shortfall_analysis']) && in_array('view', $permissions['shortfall_analysis']))
                                <li>
            ...
            @php
                $hasChannel =
                    (isset($permissions['channel_master']) && in_array('view', $permissions['channel_master'])) ||
                    (isset($permissions['channel_promotion_master']) &&
                        in_array('view', $permissions['channel_promotion_master'])) ||
                    (isset($permissions['return_analysis_channel']) &&
                        in_array('view', $permissions['return_analysis_channel'])) ||
                    (isset($permissions['expenses_analysis_channel']) &&
                        in_array('view', $permissions['expenses_analysis_channel'])) ||
                    (isset($permissions['review_analysis_channel']) &&
                        in_array('view', $permissions['review_analysis_channel'])) ||
                    (isset($permissions['health_analysis_channel']) &&
                        in_array('view', $permissions['health_analysis_channel'])) ||
                    (isset($permissions['listing_analysis_channel']) &&
                        in_array('view', $permissions['listing_analysis_channel'])) ||
                    (isset($permissions['shipping_analysis_channel']) &&
                        in_array('view', $permissions['shipping_analysis_channel'])) ||
                    (isset($permissions['ccare_analysis_channel']) &&
                        in_array('view', $permissions['ccare_analysis_channel']));
            @endphp
                        ...
                        <ul class="side-nav-second-level">
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="activeChannelMasyer">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['channel_master']) && in_array('view', $permissions['channel_master']))
                                            <li>
                            ...
                            @if (isset($permissions['channel_promotion_master']) && in_array('view', $permissions['channel_promotion_master']))
                                <li>
                            ...
                            @if (isset($permissions['return_analysis_channel']) && in_array('view', $permissions['return_analysis_channel']))
                                <li>
                            ...
                            @if (isset($permissions['expenses_analysis_channel']) && in_array('view', $permissions['expenses_analysis_channel']))
                                <li>
                                    <a href="{{ route('expenses.master') }}">Expenses Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['review_analysis_channel']) && in_array('view', $permissions['review_analysis_channel']))
                                <li>
                                    <a href="{{ route('review.master') }}">Review Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['health_analysis_channel']) && in_array('view', $permissions['health_analysis_channel']))
                                <li>
                                    <a href="{{ route('health.master') }}">Health Analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['listing_analysis_channel']) && in_array('view', $permissions['listing_analysis_channel']))
                                <li>
                                    <a href="{{ route('channel.master', ['channels', 'returns-analysis']) }}">Listing
                                        analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['shipping_analysis_channel']) && in_array('view', $permissions['shipping_analysis_channel']))
                                <li>
                                    <a href="{{ route('channel.master', ['channels', 'expenses-analysis']) }}">Shipping
                                        analysis</a>
                                </li>
                            @endif
                            @if (isset($permissions['ccare_analysis_channel']) && in_array('view', $permissions['ccare_analysis_channel']))
                                <li>
                                    <a href="{{ route('channel.master', ['channels', 'advertisement-analysis']) }}">C
                                        Care
                                        Analysis</a>
                                </li>
                            @endif
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPages2">
                    <ul class="side-nav-second-level">
                        @if (isset($permissions['listing_master']) && in_array('view', $permissions['listing_master']))
                            <li>
                        ...
                        @if (isset($permissions['mm_video_posted']) && in_array('view', $permissions['mm_video_posted']))
                            <li class="side-nav-item">
            ...
            @php
                $hasShopify =
                    (isset($permissions['shopify_products']) && in_array('view', $permissions['shopify_products'])) ||
                    (isset($permissions['shopify_inventory']) && in_array('view', $permissions['shopify_inventory'])) ||
                    (isset($permissions['shopify_movement_analysis_yoy']) &&
                        in_array('view', $permissions['shopify_movement_analysis_yoy'])) ||
                    (isset($permissions['shopify_movement_analysis_mom']) &&
                        in_array('view', $permissions['shopify_movement_analysis_mom'])) ||
                    (isset($permissions['shopify_movement_analysis_sos']) &&
                        in_array('view', $permissions['shopify_movement_analysis_sos'])) ||
                    (isset($permissions['shopify_forecast_analysis']) &&
                        in_array('view', $permissions['shopify_forecast_analysis']));
            @endphp
            ...
            @if ($hasShopify)
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages">
                        <ul class="side-nav-second-level">
                            @if (isset($permissions['shopify_products']) && in_array('view', $permissions['shopify_products']))
                                <li>
                                    <a href="{{ route('shopify', ['products', 'shopify-Products']) }}">Products</a>
                                </li>
                            @endif
                            @if (isset($permissions['shopify_inventory']) && in_array('view', $permissions['shopify_inventory']))
                                <li>
                                    <a href="{{ route('second', ['products', 'inventory']) }}">Inventory</a>
                                </li>
                            @endif
                            @if (isset($permissions['shopify_movement_analysis_yoy']) &&
                                    in_array('view', $permissions['shopify_movement_analysis_yoy']))
                                <li>
                            ...
                            @endif
                            @if (isset($permissions['shopify_movement_analysis_mom']) &&
                                    in_array('view', $permissions['shopify_movement_analysis_mom']))
                                <li>
                            ...
                            @endif
                            @if (isset($permissions['shopify_movement_analysis_sos']) &&
                                    in_array('view', $permissions['shopify_movement_analysis_sos']))
                                <li>
                                    <a href="{{ route('second', ['products', 'amazon-Products']) }}">Movement Anlys
                                        S2S</a>
                            ...
                            @endif
                            @if (isset($permissions['shopify_forecast_analysis']) && in_array('view', $permissions['shopify_forecast_analysis']))
                                <li>
            ...
            @php
                $hasInventoryManagement =
                    (isset($permissions['verifications_adjustments']) &&
                        in_array('view', $permissions['verifications_adjustments'])) ||
                    (isset($permissions['incoming_returns']) && in_array('view', $permissions['incoming_returns'])) ||
                    (isset($permissions['outgoing_reissues']) && in_array('view', $permissions['outgoing_reissues'])) ||
                    (isset($permissions['incoming_shipments']) &&
                        in_array('view', $permissions['incoming_shipments'])) ||
                    (isset($permissions['outgoing_shipments']) &&
                        in_array('view', $permissions['outgoing_shipments'])) ||
                    (isset($permissions['trash_entries']) && in_array('view', $permissions['trash_entries'])) ||
                    (isset($permissions['pallete_sales']) && in_array('view', $permissions['pallete_sales'])) ||
                    (isset($permissions['view_inventory']) && in_array('view', $permissions['view_inventory'])) ||
                    (isset($permissions['stock_adjustment']) && in_array('view', $permissions['stock_adjustment']));
            @endphp
            ...
            @if ($hasInventoryManagement)
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="invsidebarPages">
                        <ul class="side-nav-second-level">
                            @if (isset($permissions['view_inventory']) && in_array('view', $permissions['view_inventory']))
                                <li>
                                    <a href="{{ route('view-inventory') }}">View Inventory</a>
                                </li>
                            @endif
                            @if (isset($permissions['verifications_adjustments']) && in_array('view', $permissions['verifications_adjustments']))
                                <li>
                                    <a href="{{ route('verify-adjust') }}">Verifications & Adjustments</a>
                                </li>
                            @endif
                            @if (isset($permissions['incoming_returns']) && in_array('view', $permissions['incoming_returns']))
                                <li>
                                    <a href="{{ route('incoming.view') }}">Incoming</a>
                                </li>
                            @endif
                            @if (isset($permissions['outgoing_reissues']) && in_array('view', $permissions['outgoing_reissues']))
                                <li>
                                    <a href="{{ route('outgoing.view') }}">Outgoing</a>
                                </li>
                            @endif
                            @if (isset($permissions['incoming_shipments']) && in_array('view', $permissions['incoming_shipments']))
                                <li>
                                    <a href="{{ route('stock.adjustment.view') }}">Stock Adjustment</a>
                                </li>
                            @endif
                            @if (isset($permissions['outgoing_shipments']) && in_array('view', $permissions['outgoing_shipments']))
                                <li>
                            ...
                            @endif
                            @if (isset($permissions['trash_entries']) && in_array('view', $permissions['trash_entries']))
                                <li>
                                    <a href="#">Trash Entries</a>
                                </li>
                            @endif
                            @if (isset($permissions['pallete_sales']) && in_array('view', $permissions['pallete_sales']))
                                <li>
            ...
            {{-- Inventory Warehouse --}}
            @php
                $hasInventoryWarehouse =
                    (isset($permissions['list_all_warehouses']) &&
                        in_array('view', $permissions['list_all_warehouses'])) ||
                    (isset($permissions['create_new_warehouse']) &&
                        in_array('view', $permissions['create_new_warehouse'])) ||
                    (isset($permissions['inventory_locator']) && in_array('view', $permissions['inventory_locator'])) ||
                    (isset($permissions['transfers']) && in_array('view', $permissions['transfers']));
            @endphp

            @if ($hasInventoryWarehouse)
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="waresidebarPages">
                        <ul class="side-nav-second-level">
                            @if (isset($permissions['list_all_warehouses']) && in_array('view', $permissions['list_all_warehouses']))
                                <li>
                            ...
                            @if (isset($permissions['inventory_locator']) && in_array('view', $permissions['inventory_locator']))
                                <li>
                                    <a href="#">Inventory Locator</a>
                                </li>
                            @endif
                            @if (isset($permissions['transfers']) && in_array('view', $permissions['transfers']))
                                <li>
                                    <a href="#">Transfers</a>
                                </li>
                            @endif
            ...
            @php
                $hasMarketplace =
                    (isset($permissions['amazon_analytics']) && in_array('view', $permissions['amazon_analytics'])) ||
                    (isset($permissions['amazon_fba_analysis']) &&
                        in_array('view', $permissions['amazon_fba_analysis'])) ||
                    (isset($permissions['fba_inv_age']) && in_array('view', $permissions['fba_inv_age'])) ||
                    (isset($permissions['listing_audit_amazon']) &&
                        in_array('view', $permissions['listing_audit_amazon'])) ||
                    (isset($permissions['ebay']) && in_array('view', $permissions['ebay'])) ||
                    (isset($permissions['ebay_zero_view']) && in_array('view', $permissions['ebay_zero_view'])) ||
                    (isset($permissions['listing_ebay']) && in_array('view', $permissions['listing_ebay'])) ||
                    (isset($permissions['listing_audit_ebay']) &&
                        in_array('view', $permissions['listing_audit_ebay'])) ||
                    ...
                    (isset($permissions['listing_audit_doba']) &&
                        in_array('view', $permissions['listing_audit_doba'])) ||
                    (isset($permissions['shopify_b2c']) && in_array('view', $permissions['shopify_b2c'])) ||
                    (isset($permissions['shopifyb2c_zero_view']) &&
                        in_array('view', $permissions['shopifyb2c_zero_view'])) ||
                    (isset($permissions['listing_audit_shopifyb2c']) &&
                        in_array('view', $permissions['listing_audit_shopifyb2c'])) ||
                    (isset($permissions['macys']) && in_array('view', $permissions['macys'])) ||
                    (isset($permissions['macys_zero_view']) && in_array('view', $permissions['macys_zero_view'])) ||
                    (isset($permissions['listing_audit_macys']) &&
                        in_array('view', $permissions['listing_audit_macys'])) ||
                    (isset($permissions['newegg_b2c']) && in_array('view', $permissions['newegg_b2c'])) ||
                    (isset($permissions['neweggb2c_zero_view']) &&
                        in_array('view', $permissions['neweggb2c_zero_view'])) ||
                    (isset($permissions['listing_audit_Neweggb2c']) &&
                        in_array('view', $permissions['listing_audit_Neweggb2c'])) ||
                    ...
                    (isset($permissions['listing_audit_wayfair']) &&
                        in_array('view', $permissions['listing_audit_wayfair'])) ||
                    (isset($permissions['shopify_b2b']) && in_array('view', $permissions['shopify_b2b'])) ||
                    (isset($permissions['reverb']) && in_array('view', $permissions['reverb'])) ||
                    (isset($permissions['faire']) && in_array('view', $permissions['faire'])) ||
                    (isset($permissions['newegg_b2b']) && in_array('view', $permissions['newegg_b2b'])) ||
                    (isset($permissions['mercari']) && in_array('view', $permissions['mercari'])) ||
                    (isset($permissions['tiendamia']) && in_array('view', $permissions['tiendamia'])) ||
                    (isset($permissions['sears']) && in_array('view', $permissions['sears'])) ||
                    (isset($permissions['walmart']) && in_array('view', $permissions['walmart'])) ||
                    (isset($permissions['pls']) && in_array('view', $permissions['pls'])) ||
                    (isset($permissions['doba']) && in_array('view', $permissions['doba'])) ||
                    (isset($permissions['spocket']) && in_array('view', $permissions['spocket'])) ||
                    (isset($permissions['zendrop']) && in_array('view', $permissions['zendrop'])) ||
                    (isset($permissions['syncee']) && in_array('view', $permissions['syncee'])) ||
                    (isset($permissions['appscenic']) && in_array('view', $permissions['appscenic'])) ||
                    (isset($permissions['auto_ds']) && in_array('view', $permissions['auto_ds'])) ||
                    (isset($permissions['business_5core']) && in_array('view', $permissions['business_5core'])) ||
                    (isset($permissions['temu']) && in_array('view', $permissions['temu'])) ||
                    (isset($permissions['temu_zero_view']) && in_array('view', $permissions['temu_zero_view'])) ||
                    (isset($permissions['listing_audit_temu']) &&
                        in_array('view', $permissions['listing_audit_temu'])) ||
                    (isset($permissions['flea_market']) && in_array('view', $permissions['flea_market'])) ||
                    (isset($permissions['music_schools']) && in_array('view', $permissions['music_schools'])) ||
                    (isset($permissions['schools']) && in_array('view', $permissions['schools'])) ||
                    (isset($permissions['sports_classes']) && in_array('view', $permissions['sports_classes'])) ||
                    (isset($permissions['sports_shops']) && in_array('view', $permissions['sports_shops'])) ||
                    (isset($permissions['marine_shops']) && in_array('view', $permissions['marine_shops'])) ||
                    (isset($permissions['fb_shop']) && in_array('view', $permissions['fb_shop'])) ||
                    (isset($permissions['instagram_shop']) && in_array('view', $permissions['instagram_shop'])) ||
                    (isset($permissions['tiktok_shop']) && in_array('view', $permissions['tiktok_shop'])) ||
                    (isset($permissions['offerup']) && in_array('view', $permissions['offerup'])) ||
                    (isset($permissions['institutional_sales']) &&
                        in_array('view', $permissions['institutional_sales'])) ||
                    (isset($permissions['range_me']) && in_array('view', $permissions['range_me'])) ||
                    (isset($permissions['wholesale_central']) && in_array('view', $permissions['wholesale_central'])) ||
                    (isset($permissions['poshmark']) && in_array('view', $permissions['poshmark'])) ||
                    (isset($permissions['wish']) && in_array('view', $permissions['wish'])) ||
                    (isset($permissions['dhgate']) && in_array('view', $permissions['dhgate']));
            @endphp
                        ...
                        <ul class="side-nav-second-level">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarSecondLevel">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['amazon_analytics']) && in_array('view', $permissions['amazon_analytics'])) ||
                                                (isset($permissions['amz_zero_view']) && in_array('view', $permissions['amz_zero_view'])) ||
                                                (isset($permissions['amazon_low_visibility']) && in_array('view', $permissions['amazon_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="amazonSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['amazon_analytics']) && in_array('view', $permissions['amazon_analytics']))
                                                            <li>
                                                                <a href="{{ route('overall.amazon') }}">Amazon
                                                                    Analytics</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['amz_zero_view']) && in_array('view', $permissions['amz_zero_view']))
                                                            <li>
                                                                <a href="{{ route('amazon.zero.view') }}">Amazon 0
                                                                    view</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['amazon_low_visibility']) && in_array('view', $permissions['amazon_low_visibility']))
                                                            <li>
                                        ...
                                        {{-- Amazon FBA submenu --}}
                                        @if (
                                            (isset($permissions['amazon_fba_analysis']) && in_array('view', $permissions['amazon_fba_analysis'])) ||
                                                (isset($permissions['fba_inv_age']) && in_array('view', $permissions['fba_inv_age'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="amazonFbaSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['amazon_fba_analysis']) && in_array('view', $permissions['amazon_fba_analysis']))
                                                            <li>
                                                        ...
                                                        @endif
                                                        @if (isset($permissions['fba_inv_age']) && in_array('view', $permissions['fba_inv_age']))
                                                            <li>
                                        ...
                                        @if (isset($permissions['amazon_pricing']) && in_array('view', $permissions['amazon_pricing']))
                                            <li>
                                                <a href="#">Amazon Pricing</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_amazon']) && in_array('view', $permissions['listing_amazon']))
                                            <li>
                                                <a href="{{ route('listing.amazon') }}">Listing Amazon</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_audit_amazon']) && in_array('view', $permissions['listing_audit_amazon']))
                                            <li>
                                ...
                                <div class="collapse" id="sidebarThirdLevel">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['ebay']) && in_array('view', $permissions['ebay'])) ||
                                                (isset($permissions['ebay_zero_view']) && in_array('view', $permissions['ebay_zero_view'])) ||
                                                (isset($permissions['ebay_low_visibility']) && in_array('view', $permissions['ebay_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="ebaySubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['ebay']) && in_array('view', $permissions['ebay']))
                                                            <li>
                                                                <a href="{{ route('ebay') }}">eBay Analytics</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['ebay_zero_view']) && in_array('view', $permissions['ebay_zero_view']))
                                                            <li>
                                                                <a href="{{ route('ebay.zero.view') }}">eBay 0
                                                                    view</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['ebay_low_visibility']) && in_array('view', $permissions['ebay_low_visibility']))
                                                            <li>
                                        ...
                                        @if (isset($permissions['listing_audit_ebay']) && in_array('view', $permissions['listing_audit_ebay']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarshopifyb2c">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['shopify_b2c']) && in_array('view', $permissions['shopify_b2c'])) ||
                                                (isset($permissions['shopifyb2c_zero_view']) && in_array('view', $permissions['shopifyb2c_zero_view'])) ||
                                                (isset($permissions['shopifyb2c_low_visibility']) &&
                                                    in_array('view', $permissions['shopifyb2c_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="shopifyb2cSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['shopify_b2c']) && in_array('view', $permissions['shopify_b2c']))
                                                            <li>
                                                        ...
                                                        @if (isset($permissions['shopifyb2c_low_visibility']) && in_array('view', $permissions['shopifyb2c_low_visibility']))
                                                            <li>
                                                                <a
                                                                    href="{{ route('shopifyB2C.low.visibility.view') }}">ShopifyB2c
                                                                    Low Visibility</a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                        ...
                                        @if (isset($permissions['listing_shopifyb2c']) && in_array('view', $permissions['listing_shopifyb2c']))
                                            <li>
                                                <a href="{{ route('listing.shopifyb2c') }}">Listing Shopify B2C</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_audit_shopifyb2c']) && in_array('view', $permissions['listing_audit_shopifyb2c']))
                                            <li>
                                ...
                                <div class="collapse" id="sidebarmacy">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['macys']) && in_array('view', $permissions['macys'])) ||
                                                (isset($permissions['macys_zero_view']) && in_array('view', $permissions['macys_zero_view'])) ||
                                                (isset($permissions['macy_low_visibility']) && in_array('view', $permissions['macy_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="macysSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['macys']) && in_array('view', $permissions['macys']))
                                                            <li>
                                                                <a href="{{ route('macys') }}">Macy's Analytics</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['macys_zero_view']) && in_array('view', $permissions['macys_zero_view']))
                                                            <li>
                                                                <a href="{{ route('macy.zero.view') }}">Macy's 0
                                                                    view</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['macy_low_visibility']) && in_array('view', $permissions['macy_low_visibility']))
                                                            <li>
                                        ...
                                        @if (isset($permissions['listing_macys']) && in_array('view', $permissions['listing_macys']))
                                            <li>
                                                <a href="{{ route('listing.macys') }}">Listing Macy's</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_audit_macys']) && in_array('view', $permissions['listing_audit_macys']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarwayfair">
                                    <ul class="side-nav-third-level">
                                        ...
                                        @if (isset($permissions['listing_wayfair']) && in_array('view', $permissions['listing_wayfair']))
                                            <li>
                                                <a href="{{ route('listing.wayfair') }}">Listing Wayfair</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_audit_wayfair']) && in_array('view', $permissions['listing_audit_wayfair']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarReverb">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['reverb']) && in_array('view', $permissions['reverb'])) ||
                                                (isset($permissions['reverb_zero_view']) && in_array('view', $permissions['reverb_zero_view'])) ||
                                                (isset($permissions['reverb_low_visibility']) && in_array('view', $permissions['reverb_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="reverbSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['reverb']) && in_array('view', $permissions['reverb']))
                                                            <li>
                                                        ...
                                                        @endif
                                                        @if (isset($permissions['reverb_low_visibility']) && in_array('view', $permissions['reverb_low_visibility']))
                                                            <li>
                                        ...
                                        @if (isset($permissions['listing_reverb']) && in_array('view', $permissions['listing_reverb']))
                                            <li>
                                                <a href="{{ route('listing.reverb') }}">Listing Reverb</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_audit_reverb']) && in_array('view', $permissions['listing_audit_reverb']))
                                            <li>
                                ...
                                <div class="collapse" id="sidebarTemu">
                                    <ul class="side-nav-third-level">
                                        @if (
                                            (isset($permissions['temu']) && in_array('view', $permissions['temu'])) ||
                                                (isset($permissions['temu_zero_view']) && in_array('view', $permissions['temu_zero_view'])) ||
                                                (isset($permissions['temu_low_visibility']) && in_array('view', $permissions['temu_low_visibility'])))
                                            <li>
                                                ...
                                                <div class="collapse" id="temuSubmenu">
                                                    <ul class="side-nav-fourth-level">
                                                        @if (isset($permissions['temu']) && in_array('view', $permissions['temu']))
                                                            <li>
                                                                <a href="{{ route('temu') }}">Temu</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['temu_zero_view']) && in_array('view', $permissions['temu_zero_view']))
                                                            <li>
                                                                <a href="{{ route('temu.zero.view') }}">Temu 0
                                                                    view</a>
                                                            </li>
                                                        @endif
                                                        @if (isset($permissions['temu_low_visibility']) && in_array('view', $permissions['temu_low_visibility']))
                                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarEbay2">
                                    <ul class="side-nav-third-level">
                                        <li>
                                            ...
                                            <div class="collapse" id="ebay2Submenu">
                                                <ul class="side-nav-fourth-level">
                                                    ...
                                                    @if (isset($permissions['ebayTwo_zero_view']) && in_array('view', $permissions['ebayTwo_zero_view']))
                                                        <li>
                                        ...
                                        @if (isset($permissions['listing_ebayTwo']) && in_array('view', $permissions['listing_ebayTwo']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarEbay3">
                                    <ul class="side-nav-third-level">
                                        <li>
                                            ...
                                            <div class="collapse" id="ebay3Submenu">
                                                <ul class="side-nav-fourth-level">
                                                    ...
                                                    @if (isset($permissions['ebayThree_low_visibility']) && in_array('view', $permissions['ebayThree_low_visibility']))
                                                        <li>
                                                    ...
                                                    @if (isset($permissions['ebayThree_zero_view']) && in_array('view', $permissions['ebayThree_zero_view']))
                                                        <li>
                                        ...
                                        @if (isset($permissions['listing_ebayThree']) && in_array('view', $permissions['listing_ebayThree']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarWalmart">
                                    <ul class="side-nav-third-level">
                                        <li>
                                            ...
                                            <div class="collapse" id="walmartSubmenu">
                                                <ul class="side-nav-fourth-level">
                                                    ...
                                                    @if (isset($permissions['walmart_zero_view']) && in_array('view', $permissions['walmart_zero_view']))
                                                        <li>
                                        ...
                                        @if (isset($permissions['listing_walmart']) && in_array('view', $permissions['listing_walmart']))
                                            <li>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarAliexpress">
                                    <ul class="side-nav-third-level">
                                        ...
                                        @if (isset($permissions['listing_aliexpress']) && in_array('view', $permissions['listing_aliexpress']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarShopifyWholesale">
                                    <ul class="side-nav-third-level">
                                        ...
                                        @if (isset($permissions['shopify_wholesale_zero_view']) && in_array('view', $permissions['shopify_wholesale_zero_view']))
                                            <li>
                                        ...
                                        @if (isset($permissions['listing_shopifywholesale']) && in_array('view', $permissions['listing_shopifywholesale']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarFaire">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['faire_zero_view']) && in_array('view', $permissions['faire_zero_view']))
                                            <li><a href="{{ route('zero.faire') }}">Faire 0 view</a></li>
                                        @endif

                                        @if (isset($permissions['listing_faire']) && in_array('view', $permissions['listing_faire']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarTiktokShop">
                                    <ul class="side-nav-third-level">
                                        ...
                                        @if (isset($permissions['listing_tiktokshop']) && in_array('view', $permissions['listing_tiktokshop']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarMercariWShip">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['mercariwship_zero_view']) && in_array('view', $permissions['mercariwship_zero_view']))
                                            <li>
                                                <a href="{{ route('zero.mercariwship') }}">Mercari w Ship 0 view</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_mercariwship']) && in_array('view', $permissions['listing_mercariwship']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarFBMarketplace">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['fbmarketplace_zero_view']) && in_array('view', $permissions['fbmarketplace_zero_view']))
                                            <li>
                                        ...
                                        @if (isset($permissions['listing_fbmarketplace']) && in_array('view', $permissions['listing_fbmarketplace']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarBusiness5Core">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['business5core_zero_view']) && in_array('view', $permissions['business5core_zero_view']))
                                            <li>
                                        ...
                                        @if (isset($permissions['listing_business5core']) && in_array('view', $permissions['listing_business5core']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarPLS">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['pls_zero_view']) && in_array('view', $permissions['pls_zero_view']))
                                            <li>
                                                <a href="{{ route('zero.pls') }}">PLS 0 view</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_pls']) && in_array('view', $permissions['listing_pls']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarMercariWoShip">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['mercariwoship_zero_view']) && in_array('view', $permissions['mercariwoship_zero_view']))
                                            <li>
                                        ...
                                        @if (isset($permissions['listing_mercariwoship']) && in_array('view', $permissions['listing_mercariwoship']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarTiendamia">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['tiendamia_zero_view']) && in_array('view', $permissions['tiendamia_zero_view']))
                                            <li>
                                                <a href="{{ route('zero.tiendamia') }}">Tiendamia 0 view</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_tiendamia']) && in_array('view', $permissions['listing_tiendamia']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarShein">
                                    <ul class="side-nav-third-level">
                                        ...
                                        @if (isset($permissions['shein_zero_view']) && in_array('view', $permissions['shein_zero_view']))
                                            <li><a href="{{ route('zero.shein') }}">Shein 0 view</a></li>
                                        @endif
                                        @if (isset($permissions['listing_shein']) && in_array('view', $permissions['listing_shein']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarFBShop">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['fbshop_zero_view']) && in_array('view', $permissions['fbshop_zero_view']))
                                            <li>
                                                <a href="{{ route('zero.fbshop') }}">FB Shop 0 view</a>
                                            </li>
                                        @endif

                                        @if (isset($permissions['listing_fbshop']) && in_array('view', $permissions['listing_fbshop']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarInstagramShop">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['instagramshop_zero_view']) && in_array('view', $permissions['instagramshop_zero_view']))
                                            <li>
                                        ...
                                        @if (isset($permissions['listing_instagramshop']) && in_array('view', $permissions['listing_instagramshop']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarDHGate">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['dhgate_zero_view']) && in_array('view', $permissions['dhgate_zero_view']))
                                            <li><a href="{{ route('zero.dhgate') }}">DHGate 0 view</a></li>
                                        @endif

                                        @if (isset($permissions['listing_dhgate']) && in_array('view', $permissions['listing_dhgate']))
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarBestbuyUSA">
                                    <ul class="side-nav-third-level">
                                        @if (isset($permissions['bestbuyusa_zero_view']) && in_array('view', $permissions['bestbuyusa_zero_view']))
                                            <li><a href="{{ route('zero.bestbuyusa') }}">Bestbuy USA 0 view</a></li>
                                        @endif

                                        @if (isset($permissions['listing_bestbuyusa']) && in_array('view', $permissions['listing_bestbuyusa']))
