@extends('layouts.vertical', ['title' => 'BestBuy USA Analytics', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="{{ route('bestbuyusa.analytics.export') }}" class="btn btn-success">
                    ...
                    <div class="modal fade" id="bestbuyusaImportModal" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('bestbuyusa.analytics.import') }}" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="{{ route('bestbuyusa.analytics.sample') }}"
