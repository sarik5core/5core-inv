@extends('layouts.vertical', ['title' => 'Shein', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Shein', 'sub_title' => 'Market Place'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Shein Product Analysis</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="{{ route('shein.analytics.export') }}" class="btn btn-success">
                                <i class="fas fa-file-export me-1"></i> Export Live/Listings
                            </a>

                            <!-- Import Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#sheinImportModal">
                                <i class="fas fa-file-import me-1"></i> Import Live/Listings
                            </button>
                        </div>
                    </div>

                    <div class="modal fade" id="sheinImportModal" tabindex="-1" aria-labelledby="sheinImportModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('shein.analytics.import') }}" method="POST"
                                enctype="multipart/form-data" class="modal-content" id="sheinImportForm">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="sheinImportModalLabel">Import Shein Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- File Input -->
                                    <div class="mb-3">
                                        <label for="sheinExcelFile" class="form-label">Select Excel File</label>
                                        <input type="file" class="form-control" id="sheinExcelFile" name="excel_file"
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="{{ route('shein.analytics.sample') }}"
                    ...
                    <div id="data-loader" class="card-loader-overlay" style="display: none;">
                        <div class="loader-content">
                            ...
                            <div class="loader-text">Loading Shein data...</div>
                        </div>
                    </div>
                </div>
            </div>
