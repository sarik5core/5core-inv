            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3 align-items-center justify-content-between">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="createTaskModalLabel">📝 Create New Task doba to
                                                Task
                                                Manager</h4>
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <!-- Export Button -->
                            <a href="{{ route('doba.analytics.export') }}" class="btn btn-success">
                                <i class="fas fa-file-export me-1"></i> Export Live/Listings
                            </a>

                            <!-- Import Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#dobaImportModal">
                                <i class="fas fa-file-import me-1"></i> Import Live/Listings
                            </button>
                        </div>
                    </div>

                    <div class="modal fade" id="dobaImportModal" tabindex="-1" aria-labelledby="dobaImportModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('doba.analytics.import') }}" method="POST"
                                enctype="multipart/form-data" class="modal-content" id="dobaImportForm">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="dobaImportModalLabel">Import Doba Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- File Input -->
                                    <div class="mb-3">
                                        <label for="dobaExcelFile" class="form-label">Select Excel File</label>
                                        <input type="file" class="form-control" id="dobaExcelFile" name="excel_file"
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Download the <a href="{{ route('doba.analytics.sample') }}"
            ...
            $(document).on("change", ".sPriceInput", function() {
                ...
                $.ajax({
                    ...
                    success: function(info) {
                        alert("Request Sent to DOBA, Pls Wait Upto 2 Hours");
                    }
                });
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        if (response && response.data) {
                            tableData = response.data.map((item, index) => {
                                ...
                                // Calculate SCVR as doba L30 / Click 90
                                let scvr = 0;
                                if (Number(item['Click 90']) > 0) {
                                    scvr = Number(item['doba L30']) / Number(item[
                                        'Click 90']);
                                }
                                return {
                                    sl_no: index + 1,
                                    ...
                                    Roi: item['ROI'] || 0,
                                    Imp: item['Imp 90'] || 0,
                                    pickup_price: item['PICK UP PRICE '] ||
            ...
            function setupEditHandlers(modalId) {
                ...
                const editableFields = ['doba Price', 'sprice', 'LMP 1', 'link 1', 'lmp 2', 'link 2', 'lmp 3',
                    'link 3',
