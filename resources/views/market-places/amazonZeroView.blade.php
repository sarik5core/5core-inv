@extends('layouts.vertical', ['title' => 'Amazon Zero View', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Amazon Zero View', 'sub_title' => 'Amazon'])
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#saveReasonActionBtn').on('click', function() {
                ...
                if (sku) {
                    $.ajax({
                        url: '/amazon-zero/reason-action/update',
                        method: 'POST',
                        data: {
                            sku: sku,
                            reason: reason,
