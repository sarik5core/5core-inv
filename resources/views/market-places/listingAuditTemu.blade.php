@extends('layouts.vertical', ['title' => 'Listing Audit Temu', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Audit Temu', 'sub_title' => 'Temu'])
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const temuListingAuditDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                temuListingAuditDataCache.clear();
            });
            ...
            function applyColumnFilters() {
                ...
                calculateTotals();
                    ...
                    function loadData() {
                        showLoader();
                        return $.ajax({
                            url: '/listing_audit_temu/view-data',
                            type: 'GET',
                            dataType: 'json',
            ...
            function initNAEditHandlers() {
                ...
                $(document).on('change', '.na-checkbox', function(e) {
                    ...
                    $.ajax({
                        url: '/listing_audit_temu/save-na',
                        type: 'POST',
                        data: {
                            sku: sku,
                            field: field,
