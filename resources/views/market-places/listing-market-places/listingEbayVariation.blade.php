@extends('layouts.vertical', ['title' => 'Listing eBay Variation', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing eBay Variation', 'sub_title' => 'eBay Variation'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="eBayVariationListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const eBayVariationListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                eBayVariationListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_ebayvariation/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#eBayVariationListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#eBayVariationListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_ebayvariation/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
