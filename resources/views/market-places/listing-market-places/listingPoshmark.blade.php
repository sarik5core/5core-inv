@extends('layouts.vertical', ['title' => 'Listing Poshmark', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', ['page_title' => 'Listing Poshmark', 'sub_title' => 'Poshmark'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="postmarkListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const postmarkListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                postmarkListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_poshmark/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#postmarkListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#postmarkListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_poshmark/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
