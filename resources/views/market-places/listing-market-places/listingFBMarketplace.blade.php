                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_fbmarketplace.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="fbMarketplaceListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const fbMarketplaceListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                fbMarketplaceListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_fbmarketplace/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#fbMarketplaceListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#fbMarketplaceListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_fbmarketplace/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
