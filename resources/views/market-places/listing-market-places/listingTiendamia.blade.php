@extends('layouts.vertical', ['title' => 'Listing Tiendamia', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared.page-title', ['page_title' => 'Listing Tiendamia', 'sub_title' => 'Tiendamia'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="tiendmiaListing-table">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            // Cache system
            const tiendmiaListingDataCache = {
                cache: {},
            ...
            window.addEventListener('load', function() {
                tiendmiaListingDataCache.clear();
            });
            ...
            function loadData() {
                showLoader();
                return $.ajax({
                    url: '/listing_tiendamia/view-data',
                    type: 'GET',
                    dataType: 'json',
            ...
            function renderTable() {
                const $tbody = $('#tiendmiaListing-table tbody');
                $tbody.empty();
            ...
            function initResizableColumns() {
                const $table = $('#tiendmiaListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_tiendamia/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
