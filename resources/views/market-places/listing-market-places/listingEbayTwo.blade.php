@extends('layouts.vertical', ['title' => 'Listing Ebay 2', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Listing Ebay 2', 'sub_title' => 'Ebay 2'])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_ebaytwo.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
                    ...
                    <div class="table-container">
                        <table class="custom-resizable-table" id="eBayTwoListing-table">
                            <thead>
                                <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                const $tbody = $('#eBayTwoListing-table tbody');
                $tbody.empty();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    url: "{{ route('listing_ebaytwo.import') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function initResizableColumns() {
                const $table = $('#eBayTwoListing-table');
