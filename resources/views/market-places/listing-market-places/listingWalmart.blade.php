                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <a href="{{ route('listing_walmart.export') }}" class="btn btn-sm btn-success mr-3">Export</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function renderTable() {
                const $tbody = $('#walmartListing-table tbody');
                $tbody.empty();
            ...
            $(document).on('click', '#confirmImportBtn', function () {
                ...
                $.ajax({
                    url: "{{ route('listing_walmart.import') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function initResizableColumns() {
                const $table = $('#walmartListing-table');
            ...
            function saveStatusToDB(sku, data) {
                $.ajax({
                    url: '/listing_walmart/save-status',
                    type: 'POST',
                    data: {
                        sku: sku,
                        ...data,
