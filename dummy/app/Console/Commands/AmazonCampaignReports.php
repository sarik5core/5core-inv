    ...
    private function getAllowedMetricsForAdType(string $adType): array
    {
        return match($adType) {
            'SPONSORED_PRODUCTS' => [
                ...
                'purchasesSameSku30d', 'kindleEditionNormalizedPagesRead14d', 'kindleEditionNormalizedPagesRoyalties14d', 'campaignBiddingStrategy', 'startDate', 'endDate', 
            ],
            'SPONSORED_BRANDS' => [
            ...
            'SPONSORED_DISPLAY' => [
                ...
                'videoThirdQuartileViews', 'videoUnmutes', 'viewabilityRate', 'viewClickThroughRate', 'startDate', 'endDate', 
            ],
            default => []
        };
    }
