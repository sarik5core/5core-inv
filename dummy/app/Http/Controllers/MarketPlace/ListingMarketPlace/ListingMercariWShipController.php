...
{
    public function listingMercariWShip(Request $request)
    {
        ...
        return view('market-places.listing-market-places.listingMercariWShip', [
            'mercariWShipPercentage' => $percentage,
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }

    public function getViewListingMercariWShipData(Request $request)
    {
    ...
    public function saveStatus(Request $request)
    {
        ...
        $sku = $validated['sku'];
        $status = MercariWShipListingStatus::where('sku', $sku)->first();
        ...
        MercariWShipListingStatus::updateOrCreate(
            ['sku' => $validated['sku']],
            ['value' => $existing]
        );
