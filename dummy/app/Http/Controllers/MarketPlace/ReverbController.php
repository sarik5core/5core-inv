...
class ReverbController extends Controller
{
    ...
    public function getViewReverbData(Request $request)
    {
        ...
        foreach ($productMasterRows as $productMaster) {
            ...
            if (isset($reverbViewData[$sku])) {
                ...
                $processedItem["NR"] = $valuesArr["NR"] ?? false;
            } else {
    ...
    //     $values = is_array($reverbDataView->values) ? $reverbDataView->values : (json_decode($reverbDataView->values, true) ?: []);
    //     $values['NR'] = filter_var($nr, FILTER_VALIDATE_BOOLEAN);
