...
class ListingFBShopController extends Controller
{
    public function listingFBShop(Request $request)
    {
        ...
        return view('market-places.listing-market-places.listingFBShop', [
            'fbShopPercentage' => $percentage,
            'mode' => $mode,
            'demo' => $demo,
        ]);
    }

    public function getViewListingFBShopData(Request $request)
    {
    ...
    public function saveStatus(Request $request)
    {
        ...
        $sku = $validated['sku'];
        $status = FBShopListingStatus::where('sku', $sku)->first();
        ...
        FBShopListingStatus::updateOrCreate(
            ['sku' => $validated['sku']],
            ['value' => $existing]
        );
